...
outputFolder<-"/media/Helios_scStorage/Badder_Sebastian_HfPef_Model/104181/Seurat3/emptyDrops/"
sink(file = "/media/Helios_scStorage/Badder_Sebastian_HfPef_Model/104181/Seurat3/emptyDrops/Cremer_HFpEF-HFrEF_David-Seurat3.emptyDrops.rmd.log", append = TRUE, split = TRUE)
```
...
for (i in 1:length(Sample.Paths)) {
  SeuratObjectList[[i]]<-Importer(pathway = Sample.Paths[i],id = Samplenames[i], FilterByAbsoluteValues = TRUE)[[1]]
}
```
...
load("/media/Helios_scStorage/Badder_Sebastian_HfPef_Model/104181/Seurat3/Cremer_HFpEF-HFrEF_David-Seurat3.RData")
```

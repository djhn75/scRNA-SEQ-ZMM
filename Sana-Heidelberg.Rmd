...
SWAT.CD.singlet<-doubletFinder_v3(SWAT.CD.singlet, PCs = 1:10, pN = 0.25, pK = 0.09, nExp = nExp_poi, reuse.pANN = FALSE, sct = FALSE)
...
SWAT.HFD.singlet<-doubletFinder_v3(SWAT.HFD.singlet, PCs = 1:10, pN = 0.25, pK = 0.09, nExp = nExp_poi, reuse.pANN = FALSE, sct = FALSE)
...
EWAT.CD.singlet<-doubletFinder_v3(EWAT.CD.singlet, PCs = 1:10, pN = 0.25, pK = 0.09, nExp = nExp_poi, reuse.pANN = FALSE, sct = FALSE)
...
EWAT.HFD.singlet<-doubletFinder_v3(EWAT.HFD.singlet, PCs = 1:10, pN = 0.25, pK = 0.09, nExp = nExp_poi, reuse.pANN = FALSE, sct = FALSE)
...
```{r}
saveRDS(AllSample.Seurat, file = "/media/Helios_scStorage/Sana-Heidelberg/cite-seq/AllSample.SeuratObject.Rds")
AllSample.Seurat<-readRDS("/media/Helios_scStorage/Sana-Heidelberg/cite-seq/AllSample.SeuratObject.Rds")
```

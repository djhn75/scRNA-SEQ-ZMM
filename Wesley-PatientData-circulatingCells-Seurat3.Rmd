...
####Plot Neutrophil Markers
```{r}
FeaturePlot(object = CD31.circulatingCells,features.plot = c("CD68"))
VlnPlot(object = CD31.circulatingCells,features.plot = c("CD68"))

```



## 3.2.7) Cluster specific markers
```{r}
CD31.circulatingCells <- SetAllIdent(object = CD31.circulatingCells, id = "res.0.6")
CD31.circulatingCells.markers <- FindAllMarkers(object = CD31.circulatingCells, only.pos = TRUE)
# --> No DEGs found
...
## 3.2.10.) Remove HF1,HF2,HF7,CTRL_YOUNG1 for CIRC Res Paper
```{r}
CD31.circulatingCells<-SetAllIdent(CD31.circulatingCells,id = "orig.ident")
